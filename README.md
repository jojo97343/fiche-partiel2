    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .menu-item::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(90deg, rgba(77,150,255,.07), transparent);
            opacity: 0;
        ...
        .burger:hover { border-color: var(--accent2); }
...
<body>
    ...
    <nav>
        ...
        <div class="nav-footer">
            ...
            <div style="font-size:.7rem;color:var(--muted)">2025–26</div>
        </div>
    </nav>
    ...
    <script>
        ...
        function loadPage(fileName, element, label) {
            ...
            if (element) {
                ...
                // Trouver le bon item par fileName
                document.querySelectorAll('.menu-item').forEach(item => {
                    const fn = item.getAttribute('onclick').match(/'([^']+\.html)'/);
                    if (fn && fn[1] === fileName) item.classList.add('active');
                });
            }
            ...
            // Afficher le wrapper iframe
            const wrapper = document.getElementById('iframe-wrapper');
            wrapper.classList.add('visible');

            // Fermer le volet sur mobile après sélection
